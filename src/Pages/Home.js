...
const Home =()=>{
    ...
    return(
        <div>
            ...
            <img src={COver} alt="" style={{maxWidth:"100%", minWidth:"100%"}} height='50%' />
         ...
         <div className="info">
            ...
            <div>
                <h1 style={{textAlign:'center'}}><strong><u>New In</u></strong></h1>
                
                 <div  className='Home'>
                {data.slice(0,4).map((val, key)=>{
                    return(
                        <div key={key} className='home-con'>
                            <Link to={`/shoe${val.id}`}>
                            <img src={val.image} alt="" width="200px" />
                            </Link>
                            <br />
                            {val.Name}
                        </div>
                ...
                <img src={cover2} alt='' style={{maxWidth:'100%', minWidth:'100%'}} />
